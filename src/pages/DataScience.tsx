...
const modules = [
  {
    ...
    desc: "Build scalable data pipelines, ETL processes, and data warehousing solutions for enterprise-grade analytics.",
  },
  {
    icon: BarChart3,
    title: "Advanced Analytics & Visualization",
    desc: "Transform raw data into actionable insights using modern visualization tools and statistical methods.",
  },
  {
    icon: BrainCircuit,
    title: "Machine Learning & AI",
    desc: "Implement supervised and unsupervised models for predictive analytics, NLP, and computer vision.",
  },
  {
    icon: Server,
    title: "Big Data Infrastructure",
    desc: "Design and manage distributed computing platforms with Hadoop, Spark, and cloud-native data services.",
  },
  {
    icon: GitBranch,
    title: "MLOps & Model Deployment",
    desc: "Automate ML pipelines, model versioning, and production deployment with CI/CD best practices.",
  },
  {
    icon: Cpu,
    title: "AI for Government & Policy",
    desc: "Apply data science to public policy, smart governance, fraud detection, and citizen services optimization.",
  },
];
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {modules.map((m, i) => (
              ...
              >
                ...
                <div className="inline-flex items-center justify-center w-11 h-11 rounded-lg gradient-teal mb-5">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-foreground mb-4">Ready to Transform with Data?</h2>
          <p className="text-muted-foreground mb-8 max-w-lg mx-auto">Join our next cohort and become a certified data science and engineering professional.</p>
          <Link to="/#contact" className="inline-block gradient-teal text-accent-foreground px-8 py-3 rounded-md font-semibold hover:opacity-90 transition-opacity">
            Enroll Now
          </Link>
        </div>
      </section>
