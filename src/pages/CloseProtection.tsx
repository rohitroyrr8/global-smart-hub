    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-foreground mb-4">Ready to Begin Your Training?</h2>
          <p className="text-muted-foreground mb-8 max-w-lg mx-auto">Join our elite Close Protection Officer program and gain the skills to protect high-profile individuals worldwide.</p>
